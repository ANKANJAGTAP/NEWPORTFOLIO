...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "ankanjagtap.2005@gmail.com",
    href: "mailto:ankanjagtap.2005@gmail.com",
  ...
  },
  {
    ...
    content: "/ankan-jagtap-0633ab28a",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/ANKANJAGTAP",
    content: "/ankan-jagtap",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Ankan Jagtap</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Ankan, a Fullstack developer passionate about
